 ...
 */
final class Version20200804134232 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(255) NOT NULL, roles CLOB NOT NULL --(DC2Type:array)
        , password VARCHAR(64) NOT NULL, username VARCHAR(255) NOT NULL)');
